...
const Details = () => {
  return (
    <div className='p-8 flex justify-center w-[80%] mx-auto  my-8  bg-gray-300 rounded-lg shadow-lg shadow-gray-700'>
      ...
      <div className=' w-[50%]'>
      <h1 className='  font-bold text-xl text-black p-2'>Recipient details </h1> <br />
...
<br />
            {/* ======current location ==== */}
            <button className='bg-black text-white  font-bold text-xl  rounded-xl p-1  w-[50%] mx-auto '>Current Location</button>
            <br />
            <hr />
