...
import { FiMail, FiLock, FiArrowRight, FiDroplet } from "react-icons/fi";
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.statusCode === 200) {
        ...
        dispatch(authLogin({ token: res.data.accessToken, type: "donor" }));
        ...
        <div className="card bg-base-100 shadow-2xl border border-base-300">
          <div className="card-body space-y-6">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-base-content/70">Welcome back, lifesaver!</p>
            </div>
            ...
            <div className="text-center mt-4">
              <p className="text-sm">
                ...
                <Link to="/Donor_Register" className="text-primary font-semibold hover:underline">
                  Register here
                </Link>
              </p>
            </div>
