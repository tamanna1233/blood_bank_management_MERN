...
<div className='flex'>
<img src={bgimg} alt="" className='w-[53%] absolute top-0 z-[-100]'/>
</div>
<div className='w-96 '>
    <h1 className='text-5xl font-bold pt-36 pb-4  '>Save life Donate Blood</h1>
    ...
    <button className='bg-black hover:text-black hover:border border-black hover:bg-white text-white font-bold py-2 px-4 rounded-lg items-right shadow-2xl '>Get Blood Now</button>
</div>
