...
const Find_Blood = () => {
  return (
    <div className=' m-auto p-4 flex justify-center items-center gap-4'>
      <div className='bg-white m-auto p-4 rounded-xl shadow-xl '>
        ...
        <input type="tel" requirede placeholder='Enter your mobile number ' className='p-1 border border-black  m-4 rounded-lg w-full' />
